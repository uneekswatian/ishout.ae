...
@section('title')iShout Media - Influencers Marketing Case Studies @stop
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5 offset-lg-1 offset-sm-0 bannerPic">
                    <img class="w-100" src="{{ asset('/assets/images/im-case-studies-banner.png') }}" alt="">
                </div>
                <div class="col-lg-4 offset-lg-1 bannerText align-self-center">
                    <h1>Influencers Marketing
                    <br>
                    Case Studies</h1>
                </div>
            </div>
