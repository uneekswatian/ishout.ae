...
@section('title')iShout Media - Contact @stop

@section('content')
    <header class="masthead text-white gradientPurple">
        <div class="container">
            <div class="whitePattern"></div>
            <div class="banner_left"></div>
            <div class="banner_right"></div>
            <div class="row">
                <div class="col-lg-4 offset-lg-1 offset-sm-0 bannerPic">
                    <img class="img-fluid" src="{{ asset('/assets/images/banner_contact.png') }}" alt="">
                </div>
                <div class="col-lg-4 offset-lg-2 bannerText align-self-center">
                    <h1>Get in Touch
                    <br>
                    with us</h1>
                </div>
            ...
            <div class="col-md-8 my-3 my-md-5">
                <div class="row text-left">
                    <div class="col-lg-4">
                        <h1>Start your<br>
                        Project</h1>
                        <hr class="left purple">
                        <p>Achieve your brand objectives through I Shout Tech, a highly intelligent platform.
                        </p><br>
                        <i class="fas fa-map-marked-alt fa-lg text-purple"> </i>&nbsp;&nbsp;<h3> Contact </h3>
                        <br><br>
                        <p>
                            Office 303<br>
                            Dubai Insurance Building<br>
                            150 Sheikh Zayed Road Road Dubai UAE<br>
                            Email: <a href="mailto:info@ishout.ae" class="text-purple">info@ishout.ae</a><br>
                            Phone: <a href="tel:+971 55 779 9440" class="text-purple">+971 55 779 9440</a></p>
                    </div>
